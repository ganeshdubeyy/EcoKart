  ...
  return (
    <div>
        ...
        <div className='text-sm flex items-center gap-2'>
          ...
          <Link onClick={handleClose} to={"/account/profile"} className='hover:text-primary-200'>
        ...
        <div className='text-sm grid gap-1'>
            ...
            <Link onClick={handleClose} to={"/account/myorders"} className='px-2 hover:bg-orange-200 py-1'>My Orders</Link>

            <Link onClick={handleClose} to={"/account/address"} className='px-2 hover:bg-orange-200 py-1'>Save Address</Link>
